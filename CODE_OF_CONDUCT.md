...
participation in the MetaEcosystemSuite project a harassment-free
...
- Accepting responsibility, apologizing when we make mistakes, and
...
may be reported to the maintainers at **contact@localpulse.dev**. All
...
1. **Correction** — Private, written warning for an isolated incident.
2. **Warning** — A warning with consequences for continued behavior,
   including a temporary interaction ban.
